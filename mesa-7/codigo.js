...
/*Otra opción es: tarjeta.classList.add('card'); */
...
let comprobacionLinkYouTube = linkYouTube.hasAttribute('href');
console.log(comprobacionLinkYouTube);


//5- Obtener el href del link a wikipedia y mostrarlo por consola
let linkWikipedia = document.querySelector("#link_wikipedia");
let imprimirLinkWikipedia = linkWikipedia.getAttribute('href');
console.log(imprimirLinkWikipedia);
